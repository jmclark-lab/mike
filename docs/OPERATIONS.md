...
- **DeepSeek:** adapter remains (`DEEPSEEK_API_KEY`, optional `DEEPSEEK_BASE_URL`, default `https://api.deepseek.com`). It is fenced out of the CI-facing model picker and account model dropdowns. Not a council seat.
